...
.nav .navCon .textPic .icon {
  cursor: pointer;
  width: 112px;
  height: 40px;
}
.nav .navCon .textPic .icon img {
  width: 100%;
  height: 100%;
}
.nav .navCon .search {
